...
def _create_enum_if_missing(*, enum_name: str, labels: list[str]) -> None:
  """Create a Postgres enum only when it does not already exist."""
    ...
    sa.text(
      ...
      BEGIN
        IF NOT EXISTS (SELECT 1 FROM pg_type WHERE typname = '{enum_name}') THEN
          CREATE TYPE {enum_name} AS ENUM ({quoted_labels});
        END IF;
      END
      $$;
      """
...
def upgrade() -> None:
  ...
  _create_enum_if_missing(enum_name="fensterwidgettype", labels=["INLINE_BLOB", "CDN_URL"])
  _create_enum_if_missing(enum_name="role_level", labels=["GLOBAL", "TENANT"])
  _create_enum_if_missing(enum_name="lesson_depth", labels=["highlights", "detailed", "training"])
  _create_enum_if_missing(enum_name="user_status", labels=["PENDING", "APPROVED", "DISABLED", "REJECTED"])
  _create_enum_if_missing(enum_name="auth_method", labels=["GOOGLE_SSO", "NATIVE"])
  _create_enum_if_missing(enum_name="runtime_config_scope", labels=["GLOBAL", "TIER", "TENANT", "USER"])
  _create_enum_if_missing(enum_name="quota_period", labels=["WEEK", "MONTH"])
  ...
  guarded_create_table(
    ...
    sa.Column("type", postgresql.ENUM("INLINE_BLOB", "CDN_URL", name="fensterwidgettype", create_type=False), nullable=False),
  ...
  guarded_create_table(
    ...
    sa.Column("id", sa.Uuid(), nullable=False),
    sa.Column("name", sa.String(), nullable=False),
    sa.Column("level", postgresql.ENUM("GLOBAL", "TENANT", name="role_level", create_type=False), nullable=False),
    sa.Column("description", sa.Text(), nullable=True),
    sa.PrimaryKeyConstraint("id"),
    sa.UniqueConstraint("name"),
  )
  guarded_create_table(
    ...
    sa.Column("highest_lesson_depth", postgresql.ENUM("highlights", "detailed", "training", name="lesson_depth", create_type=False), nullable=True),
  ...
  guarded_create_table(
    ...
    sa.Column("status", postgresql.ENUM("PENDING", "APPROVED", "DISABLED", "REJECTED", name="user_status", create_type=False), nullable=False),
    sa.Column("auth_method", postgresql.ENUM("GOOGLE_SSO", "NATIVE", name="auth_method", create_type=False), nullable=False),
  ...
  guarded_create_table(
    ...
    sa.Column("id", sa.Uuid(), nullable=False),
    sa.Column("key", sa.String(), nullable=False),
    sa.Column("scope", postgresql.ENUM("GLOBAL", "TIER", "TENANT", "USER", name="runtime_config_scope", create_type=False), nullable=False),
    sa.Column("org_id", sa.Uuid(), nullable=True),
