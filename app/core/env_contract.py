...
REQUIRED_ENV_REGISTRY: tuple[EnvVarDefinition, ...] = (
  ...
  EnvVarDefinition(name="DYLEN_APP_ID", required=False, secret=False, used_by="service"),
  ...
  EnvVarDefinition(name="DYLEN_MAX_TOPIC_LENGTH", required=False, secret=False, used_by="service"),
  EnvVarDefinition(name="DYLEN_MAX_MARKDOWN_CHARS", required=False, secret=False, used_by="service"),
  EnvVarDefinition(name="DYLEN_JOB_MAX_RETRIES", required=False, secret=False, used_by="service"),
  ...
  EnvVarDefinition(name="DYLEN_SECTION_BUILDER_PROVIDER", required=False, secret=False, used_by="service"),
  EnvVarDefinition(name="DYLEN_SECTION_BUILDER_MODEL", required=False, secret=False, used_by="service"),
  EnvVarDefinition(name="DYLEN_PLANNER_PROVIDER", required=False, secret=False, used_by="service"),
  EnvVarDefinition(name="DYLEN_PLANNER_MODEL", required=False, secret=False, used_by="service"),
  EnvVarDefinition(name="DYLEN_OUTCOMES_PROVIDER", required=False, secret=False, used_by="service"),
  EnvVarDefinition(name="DYLEN_OUTCOMES_MODEL", required=False, secret=False, used_by="service"),
  EnvVarDefinition(name="DYLEN_REPAIR_PROVIDER", required=False, secret=False, used_by="service"),
  EnvVarDefinition(name="DYLEN_REPAIR_MODEL", required=False, secret=False, used_by="service"),
  EnvVarDefinition(name="DYLEN_FENSTER_PROVIDER", required=False, secret=False, used_by="service"),
  EnvVarDefinition(name="DYLEN_FENSTER_MODEL", required=False, secret=False, used_by="service"),
  EnvVarDefinition(name="DYLEN_FENSTER_TECHNICAL_CONSTRAINTS", required=False, secret=False, used_by="service"),
  EnvVarDefinition(name="DYLEN_WRITING_PROVIDER", required=False, secret=False, used_by="service"),
  EnvVarDefinition(name="DYLEN_WRITING_MODEL", required=False, secret=False, used_by="service"),
  EnvVarDefinition(name="DYLEN_TUTOR_PROVIDER", required=False, secret=False, used_by="service"),
  EnvVarDefinition(name="DYLEN_TUTOR_MODEL", required=False, secret=False, used_by="service"),
  EnvVarDefinition(name="DYLEN_ILLUSTRATION_PROVIDER", required=False, secret=False, used_by="service"),
  EnvVarDefinition(name="DYLEN_ILLUSTRATION_MODEL", required=False, secret=False, used_by="service"),
  EnvVarDefinition(name="DYLEN_VISUALIZER_PROVIDER", required=False, secret=False, used_by="service"),
  EnvVarDefinition(name="DYLEN_VISUALIZER_MODEL", required=False, secret=False, used_by="service"),
  ...
  EnvVarDefinition(name="DYLEN_YOUTUBE_PROVIDER", required=False, secret=False, used_by="service"),
  EnvVarDefinition(name="DYLEN_YOUTUBE_MODEL", required=False, secret=False, used_by="service"),
  EnvVarDefinition(name="DYLEN_RESEARCH_MODEL", required=False, secret=False, used_by="service"),
  ...
  EnvVarDefinition(name="DYLEN_JOBS_AUTO_PROCESS", required=False, secret=False, used_by="service"),
  EnvVarDefinition(name="DYLEN_JOBS_TTL_SECONDS", required=False, secret=False, used_by="service"),
  EnvVarDefinition(name="DYLEN_PG_CONNECT_TIMEOUT", required=False, secret=False, used_by="service"),
  EnvVarDefinition(name="DYLEN_PG_LESSONS_TABLE", required=False, secret=False, used_by="service"),
  EnvVarDefinition(name="DYLEN_PG_JOBS_TABLE", required=False, secret=False, used_by="service"),
  EnvVarDefinition(name="DYLEN_LLM_AUDIT_ENABLED", required=False, secret=False, used_by="service"),
  EnvVarDefinition(name="DYLEN_CACHE_LESSON_CATALOG", required=False, secret=False, used_by="service"),
  ...
  EnvVarDefinition(name="DYLEN_RESEARCH_ROUTER_MODEL", required=False, secret=False, used_by="service"),
  ...
  EnvVarDefinition(name="OPENROUTER_HTTP_REFERER", required=False, secret=False, used_by="service"),
  EnvVarDefinition(name="OPENROUTER_TITLE", required=False, secret=False, used_by="service"),
  ...
  EnvVarDefinition(name="DYLEN_AUTO_APPLY_MIGRATIONS", required=False, secret=False, used_by="service"),
