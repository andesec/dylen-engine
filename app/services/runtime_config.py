...
_RUNTIME_CONFIG_DEFINITIONS: dict[str, RuntimeConfigDefinition] = {
  ...
  "ai.section_builder.provider": RuntimeConfigDefinition(key="ai.section_builder.provider", value_type="str", description="Default provider for section builder.", allowed_scopes=_SCOPES_GLOBAL_TIER_TENANT),
  "ai.section_builder.model": RuntimeConfigDefinition(key="ai.section_builder.model", value_type="str", description="Default model for section builder.", allowed_scopes=_SCOPES_GLOBAL_TIER_TENANT),
  "ai.planner.provider": RuntimeConfigDefinition(key="ai.planner.provider", value_type="str", description="Default provider for planner.", allowed_scopes=_SCOPES_GLOBAL_TIER_TENANT),
  "ai.planner.model": RuntimeConfigDefinition(key="ai.planner.model", value_type="str", description="Default model for planner.", allowed_scopes=_SCOPES_GLOBAL_TIER_TENANT),
  "ai.outcomes.provider": RuntimeConfigDefinition(key="ai.outcomes.provider", value_type="str", description="Default provider for outcomes agent.", allowed_scopes=_SCOPES_GLOBAL_TIER_TENANT),
  "ai.outcomes.model": RuntimeConfigDefinition(key="ai.outcomes.model", value_type="str", description="Default model for outcomes agent.", allowed_scopes=_SCOPES_GLOBAL_TIER_TENANT),
  "ai.repair.provider": RuntimeConfigDefinition(key="ai.repair.provider", value_type="str", description="Default provider for repair.", allowed_scopes=_SCOPES_GLOBAL_TIER_TENANT),
  "ai.repair.model": RuntimeConfigDefinition(key="ai.repair.model", value_type="str", description="Default model for repair.", allowed_scopes=_SCOPES_GLOBAL_TIER_TENANT),
  "ai.fenster.provider": RuntimeConfigDefinition(key="ai.fenster.provider", value_type="str", description="Default provider for Fenster builder.", allowed_scopes=_SCOPES_GLOBAL_TIER_TENANT),
  "ai.fenster.model": RuntimeConfigDefinition(key="ai.fenster.model", value_type="str", description="Default model for Fenster builder.", allowed_scopes=_SCOPES_GLOBAL_TIER_TENANT),
  ...
  "ai.writing.provider": RuntimeConfigDefinition(key="ai.writing.provider", value_type="str", description="Default provider for writing checks.", allowed_scopes=_SCOPES_GLOBAL_TIER_TENANT),
  "ai.writing.model": RuntimeConfigDefinition(key="ai.writing.model", value_type="str", description="Default model for writing checks.", allowed_scopes=_SCOPES_GLOBAL_TIER_TENANT),
  "ai.tutor.provider": RuntimeConfigDefinition(key="ai.tutor.provider", value_type="str", description="Default provider for tutor.", allowed_scopes=_SCOPES_GLOBAL_TIER_TENANT),
  "ai.tutor.model": RuntimeConfigDefinition(key="ai.tutor.model", value_type="str", description="Default model for tutor.", allowed_scopes=_SCOPES_GLOBAL_TIER_TENANT),
  "ai.illustration.provider": RuntimeConfigDefinition(key="ai.illustration.provider", value_type="str", description="Default provider for illustration.", allowed_scopes=_SCOPES_GLOBAL_TIER_TENANT),
  "ai.illustration.model": RuntimeConfigDefinition(key="ai.illustration.model", value_type="str", description="Default model for illustration.", allowed_scopes=_SCOPES_GLOBAL_TIER_TENANT),
  "ai.visualizer.provider": RuntimeConfigDefinition(key="ai.visualizer.provider", value_type="str", description="Legacy alias for ai.illustration.provider.", allowed_scopes=_SCOPES_GLOBAL_TIER_TENANT),
  "ai.visualizer.model": RuntimeConfigDefinition(key="ai.visualizer.model", value_type="str", description="Legacy alias for ai.illustration.model.", allowed_scopes=_SCOPES_GLOBAL_TIER_TENANT),
  "ai.youtube.provider": RuntimeConfigDefinition(key="ai.youtube.provider", value_type="str", description="Default provider for YouTube capture.", allowed_scopes=_SCOPES_GLOBAL_TIER_TENANT),
  "ai.youtube.model": RuntimeConfigDefinition(key="ai.youtube.model", value_type="str", description="Default model for YouTube capture.", allowed_scopes=_SCOPES_GLOBAL_TIER_TENANT),
