...
class JobProcessor:
  ...
  async def _process_lesson_generation(self, job: JobRecord) -> JobRecord | None:
    ...
    try:
      ...
      # Save Lesson Record
      # Sections are saved incrementally by the orchestrator, so we don't save them here to avoid duplicates.
...
_ALLOWED_RETRY_AGENTS = {"planner", "section_builder", "repair"}
