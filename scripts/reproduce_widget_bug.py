...
def test_widget_rendering():
  ...
  req = GenerationRequest(topic="Test Topic", depth="highlights", section_count=2, blueprint="knowledgeunderstanding", widgets=requested_widgets)
  ...
  if "mcqs" in prompt and "mcqs" not in requested_widgets:
    print("❌ FAIL: Unrequested widget 'mcqs' found in prompt (Prompt is ignoring preferences).")
  else:
