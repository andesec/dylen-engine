...
The DGS backend supports three LLM providers, each with distinct models and use cases:
...
export DGS_PLANNER_PROVIDER="gemini"
export DGS_PLANNER_MODEL="gemini-2.5-pro"

# To use Vertex AI (requires GCP_PROJECT_ID, GCP_LOCATION, and ADC)
export DGS_PLANNER_PROVIDER="vertexai"
export DGS_PLANNER_MODEL="vertex-gemini-2.5-pro"
```
...
**Check**:
1. Environment variables (`DGS_*_PROVIDER`)
