...
async def extract_text_from_images(files: list[UploadFile] = FILES_FIELD, message: str | None = MESSAGE_FIELD) -> BatchResponse:
  ...
  # Instantiate the OCR service to keep the route thin.
  service = OcrService()
