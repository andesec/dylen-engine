    ...
    def _output_dle_shorthand(sections: list[StructuredSection]) -> list[StructuredSection]:
        ...
        def _convert_item(item: Any) -> Any:
            ...
            if wtype in {"info", "tip", "warn", "err", "success"}:
                ...
                if isinstance(content, str) and set(item.keys()).issubset(
                    {"type", "title", "content"}
                ):
            ...
            if wtype == "compare":
                ...
                if (
                    ...
                    and matrix
                    and all(
                        isinstance(r, list) and r and all(isinstance(c, str) for c in r)
                        for r in matrix
                    )
                ):
            ...
            if wtype == "stepFlow":
                ...
                if (
                    ...
                    and set(item.keys()).issubset(known)
                ):
