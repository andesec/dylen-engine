...
def create_section_progress(section_index: int, *, title: str | None, status: SectionStatus, retry_count: int | None = None, completed_sections: int | None = None) -> SectionProgressUpdate:
