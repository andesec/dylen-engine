...
_RAW_BLUEPRINTS: list[dict[str, Any]] = [
    {
        ...
        "tooltip": "Build reliable step-by-step execution and repetition. Topics: Cooking fundamentals, workplace tools, study routines, home maintenance, keyboarding, lab technique, personal safety basics.",
    },
    {
        "id": "knowledgeunderstanding",
        "label": "Knowledge & Understanding",
        "tooltip": "Explain models, rules, and cause-and-effect clearly. Topics: Physics, biology, economics, history, linguistics, mathematics, political systems, music theory.",
    },
    {
        "id": "communicationskills",
        "label": "Communication Skills",
        "tooltip": "Practice guided interaction for better interpersonal outcomes. Topics: Negotiation, leadership, dating and relationships, teamwork, parenting, customer relations, conflict resolution, cross-cultural norms.",
    },
    {
        "id": "planningandproductivity",
        "label": "Planning and Productivity",
        "tooltip": "Design structure, sequencing, and sustainable systems. Topics: Project management, exam planning, personal finance systems, household systems, travel planning, event logistics, business operations.",
    },
    {
        "id": "movementandfitness",
        "label": "Movement and Fitness",
        "tooltip": "Build technique, form, and drill-based practice. Topics: Strength training, yoga, dance, swimming, voice training, instrument technique, handwriting, posture.",
    },
    {
        "id": "growthmindset",
        "label": "Growth Mindset",
        "tooltip": "Grow reflection, ethics, and worldview. Topics: Ethics, philosophy, civic responsibility, professional integrity, media ethics, sustainability, cultural humility.",
    },
    {
        "id": "criticalthinking",
        "label": "Critical Thinking",
        "tooltip": "Evaluate against standards and evidence. Topics: News credibility, research appraisal, art criticism, argument quality, product reviews, portfolio review, data interpretation.",
    },
    {
        "id": "creativeskills",
...
_RAW_TEACHING_STYLES: list[dict[str, Any]] = [
    {
        "id": "conceptual",
        "label": "Conceptual",
        "tooltip": "Intuition and mental models before application; best for fast clarity and orientation. Topics: Psychology basics, history overviews, nutrition basics, systems overviews, intro philosophy, big-picture science.",
    },
    {
        "id": "theoretical",
        "label": "Theoretical",
        "tooltip": "Formal and precise understanding; best for correctness, rigor, and edge cases. Topics: Grammar systems, formal logic, statistics, constitutional law, microeconomics, chemistry fundamentals.",
    },
    {
        "id": "practical",
        "label": "Practical",
        "tooltip": "Execution and application; best for getting results quickly. Topics: Language practice, fitness practice, cooking practice, public speaking practice, study practice, tool proficiency.",
    },
]
...
_DEPTH_OPTIONS: list[dict[str, str]] = [
    ...
    },
    {
        "id": "training",
        "label": "Training",
        "tooltip": "Ten sections with per-section practice and a comprehensive final exam.",
    },
]
